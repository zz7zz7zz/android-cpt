...
public abstract class DefaultHttpConfig implements IHttpConfig {
    ...
    public X509TrustManager getSSLTrustManager() {
        return new SSLTrustManager();
    }

    @Override
    public SSLSocketFactory getSSLSocketFactory(X509TrustManager sslTrustManager) {
            ...
            try {
                ...
                if (socket != null) {
                    ...
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                         ...
                         * ciphers which are enabled by default, but have become unsecure), but IHttpConfig guess for
    ...
    //-----------------------------------------------------------------------------------------
    public static final class SSLTrustManager implements X509TrustManager {
